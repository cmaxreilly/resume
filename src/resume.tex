    ...
    \section{EXPERIENCE}
        \resumeSubHeadingListStart
            ...
            {Adjunct Faculty, Resident Accompanist, Music Director}
                \resumeItemListStart
                    \resumeItem
                        {Music-director and pianist for three years of successful theater department musicals.}
                    \resumeItem
            ...
            {Choir Accompanist}
                \resumeItemListStart
                    ...
                    \resumeItem
                        ...
                        commercial.}
                    \resumeItem
                        {Played piano for musicals for the first three years there. Wrote the
                        underscoring to the drama department's production of \textit{Treasure
                        Island} by Ken Ludwig in 2023.}
                \resumeItemListEnd
